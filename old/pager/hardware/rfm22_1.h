...
#define RFM22_TCCR_DEF  0x05        // делитель 1024
#define RFM22_TCNT      TCNT0

/** Конфигурация RFM22 **/

#define PREAMBLE_LENGHT_D     24          //длина преамбулы в битах
#define CHANNEL_STEP_KHZ    120

#define CARRIER_FREQ    433.10          // частота несущей в мГц
#define DEVIATION       15              // частота девиации в кГц
#define DATA_RATE       57.6           // битрейт в кбит/с
...
#define INTERRUPT_EN1   (0x00 | (1<<PACKET_SENT) | (1<<PACKET_RECEIVED))
#define INTERRUPT_EN2   (0x00)
...
#define LOW_BATTERY_THR ((uint8_t)BAT_VOLT(2.5)&0x1f)

// эти регистры берем из файлика, ибо вломы формулы набирать
#define IF_FILTER_BW    (0x01)
#define AFC_GEAR_OVER   ()
#define AFC_TIMING_CTRL ()
#define CLKREC_GEAROVER ()
#define CLK_REC_OVER    (0xa1)
#define CLK_REC_OFFSET2 (0x20)
#define CLK_REC_OFFSET1 (0x4e)
#define CLK_REC_OFFSET0 (0xa5)
#define CLK_REC_CRGAIN1 (0x00)
#define CLK_REC_CRGAIN0 (0x34)

#define RSSI_THRESHOLD  (0xaa)

// опять из файлика
#define AFC_LIMITER     (0x1e)

#define DATA_ACC_CTRL   ( (1<<ENPACRX) | (1<<ENPACTX) )
#define HEADER_CTRL1    ((NO_BROADCAST<<4) | NO_HEAD_CHECK )
#define HEADER_CTRL2    ( (NO_HEADER<<4) | (SYNC_WORD_32<<1) | (((PREAMBLE_LENGHT_D/4)&0x100)>>8) )
#define PREAMBLE_LENGHT ((uint8_t)(PREAMBLE_LENGHT_D/4))
#define PREAMBLE_DETCTR ( (((PREAMBLE_LENGHT_D/8)&0x1f)<<3) )
...
#define TX_DATA_RATE1   (0x4e)                   // брать из файлика
#define TX_DATA_RATE0   (0xa5)                   // брать из файлика
#define MODULAT_CTRL1   (0x20)
#define MODULAT_CTRL2   ( (FIFO_MODE<<4) | ((((uint16_t)FREQDIV)&0x0100)<<2) | FSK )
#define FREQ_DEVIATION  (0x30)                   // брать из файлика
#define FREQ_BAND_SEL   (0x53)                   // брать из файлика
#define CARRIER_FREQ1   (0x4d)                   // брать из файлика
#define CARRIER_FREQ2   (0xc0)                   // брать из файлика
