...
#define ALWAYS_RX               // закомментить чтобы выключить режим постоянного ожидания пакета
#define PROGRAM_SPI_ENABLE      // закомментить чтобы работал аппаоратный SPI

#define SYNCH_WORD      0xd4

#define DATA_BYTES_MAX  24      // максимальное количество передаваемых данных в одном пакете
...
#define RFM12_IRQDDR	DDRB
#define RFM12_IRQPIN	PINB
#define RFM12_IRQ       2
...
/** собстенно здесь и происходит конфигурация RFM **/
...
void rfm12_channel(uint8_t ch);     // выбор канала
